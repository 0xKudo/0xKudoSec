...
- REMAINING: user merges `feat/xdr-phase0-foundations` → `main` when ready (VPS can then pull main); commit/push the alerts_dedup schema+migration + DetectionRules copy change. Never `sudo pm2`.
