...
const s = {
  ...
  // buttons
  btnPrimary: { background: 'var(--btn-primary-bg)', color: 'var(--btn-primary-text)', border: 'none', fontFamily: 'var(--font)', fontSize: '12px', fontWeight: 600, padding: '11px 28px', cursor: 'pointer', letterSpacing: '0.06em', textTransform: 'uppercase' },
  btnPrimaryFull: { background: 'var(--btn-primary-bg)', color: 'var(--btn-primary-text)', border: 'none', fontFamily: 'var(--font)', fontSize: '12px', fontWeight: 600, padding: '11px 28px', cursor: 'pointer', letterSpacing: '0.06em', textTransform: 'uppercase', width: '100%' },
