          ...
          <div style={s.modal} onClick={e => e.stopPropagation()}>
            ...
            <div style={s.modalBody}>
              {[
                ...
                ['HTTP Method', selected.http_method],
                ['URL', selected.http_url],
                ['HTTP Status', selected.http_status],
                ['User-Agent', selected.http_ua],
                ['Referer', selected.http_referer],
                ['File Path', selected.file_path],
                ['Expected Hash', selected.fim_hash_expected],
                ['Actual Hash', selected.fim_hash_actual],
                ['WordPress Site', selected.wp_site],
                ['WP Version', selected.wp_version],
