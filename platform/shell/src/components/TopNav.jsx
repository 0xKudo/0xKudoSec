...
const DESKTOP_DOWNLOAD_URL = 'https://github.com/0xKudoX/0xKudoSec-releases/releases/download/v1.2.44/0xKudo-Security-Toolkit-Setup-1.2.44.exe';
              ...
              <>
                {__APP_VERSION__.includes('beta') && (
                  <button
                    ...
                    title="Reload app (beta builds only)"
