...
contextBridge.exposeInMainWorld('electron', {
  ...
  llm: {
    ...
    // Renderer → main: new events arrived, trigger real-time analysis queue
    notifyNewEvents: (authToken, sinceId) => ipcRenderer.invoke('llm:notify-new-events', authToken, sinceId),
  },
});
